...
<script>
import {handleToMd, handleToMdArr} from '@/module/admin-1.0.0/handle-to-md.js'; // 处理为markdown格式
import {getTableData, getSampleDataStr} from '@/module/admin-1.0.0/common.js'; // 得到表格数据，得到选中的查看字符串模板的内容
...
export default{
    ...
    methods:{
        ...
        initData(){
            this.tableData3 = getTableData(); // 不传参，默认为数组第一个的数据
        },
        _tipSuccess(){
            this.$message({
